...
import com.ciisa.repo.IConsultaExamenRepo;
import com.ciisa.repo.IConsultaRepo;
import com.ciisa.service.IConsultaService;
...
public class ConsultaServiceImpl implements IConsultaService{
	...
	@Autowired
	private IConsultaExamenRepo ceRepo; //repo que contiene traer la query nativa de registrar
	...
	public Consulta registrarTransaccional(ConsultaListaExamenDTO dto) {
		...
		dto.getLstExamen().forEach(ex -> ceRepo.registrar(dto.getConsulta().getIdConsulta(), ex.getIdExamen())); //aquí hago la relación con examen
