...
import com.ciisa.dto.ConsultaDTO;
...
public class ConsultaController {
	...
	@PostMapping
	public ResponseEntity<Object> registrar(@Valid @RequestBody ConsultaListaExamenDTO consultaDTO) { //registra la transacción en todas las tablas relacionadas
